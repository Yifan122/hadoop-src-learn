...
public class GetJournalEditServlet extends HttpServlet {
  ...
  public void doGet(final HttpServletRequest request,
    ...
    try {
      ...
      // send edits
      //流对拷 把输入流（editFileIn）里面的数据写到输出流（response.getOutputStream()）
  ...
  //拼接journalNode上面的edit log的请求地址：/getJournal?jid=journalId&segmentTxId=segmentTxId&storageInfo=nsInfo.toColonSeparatedString()
